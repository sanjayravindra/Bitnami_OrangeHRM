...
public class DbValidation extends Property
{
    ...
    public static String DB_URL = "jdbc:mysql://localhost:3306/bitnami_orangehrm?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";   
